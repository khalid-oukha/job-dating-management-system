    ...
    <section>
        <div class="relative bg-gradient-to-r from-black to-black py-16 font-[sans-serif]">
            ...
            <div class="relative max-w-screen-xl mx-auto px-8 z-10 text-center text-white">
                ...
                @endguest
                @auth
                <a href="" type="button" class="bg-primary-100 hover:bg-primary-100 text-white text-base font-semibold px-8 py-2.5 rounded-full transition duration-300 ease-in-out shadow-lg hover:shadow-xl">View announcements</a>    
                @endauth
