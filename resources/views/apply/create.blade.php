                ...
                <div class="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
                    <div class="container mx-auto p-4">
                        <div class="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6">Here you can add Announcement's informations.
                            </p>
                            <form action="{{ route('announcement.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="user_id" class="border p-2 rounded w-full" id="">
                                            <option selected class="text-gray-900 dark:text-white" value="{{ auth()->user()->id }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="companie_id" class="border p-2 rounded w-full" id="">
                                        @foreach ($companies as $companie)
                                            <option class="text-gray-900 dark:text-white" value="{{ $companie->id }}">
