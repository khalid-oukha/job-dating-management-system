...
@section('content')
    <main id="main" class="pt-16 h-screen px-28">
        <h2 class="my-6 text-4xl font-semibold text-center font-poppins tracking-widest text-gray-700 dark:text-gray-200">
            <span class="text-primary-100 dark:text-orange">Add </span> a new skill
        </h2>
                ...
                <div class="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
                    <div class="container mx-auto p-4">
                        <div class="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6">Here you can add skill's informations.</p>
                            <form action="{{ route('skill.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" placeholder="skill Name" name="name"
