<header class="z-40 fixed w-screen top-0 py-4 flex bg-primary-100 shadow-md">
    <div id="logo" class="flex items-center ml-auto z-40">
            ...
            <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" id="sidebar-toggle-button" class="inline-flex items-center p-2 text-sm text-white rounded-lg smXl:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
    ...
    <div class="container flex items-center h-full px-6 ml-auto text-gray-600">
            ...
            <ul class="flex items-center ml-auto lg:mr-24 flex-shrink-0 space-x-6">
                ...
                <li class="relative">
                    ...
                    <ul id="notifications" class="hidden absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md">
                        <li class="flex">
